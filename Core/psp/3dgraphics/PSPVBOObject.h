...
#include "../../3dgraphics/VBOObjectIF.h"

class PSPVBOObject:public VBOObjectIF{

private:

	PSPVBOObject(const PSPVBOObject& rhs){}
	PSPVBOObject& operator = (const PSPVBOObject& rhs){return *this;}
